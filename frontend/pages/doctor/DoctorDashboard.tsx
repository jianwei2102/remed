      ...
      <div className="flex flex-row justify-between gap-4">
        <div className="basis-1/2 border rounded-lg p-4 min-h-96">
          <div className="flex flew-col justify-between">
            ...
            <div className="flex justify-center items-center">
              <Button type="link" onClick={() => navigate("/doctor/authorization")}>
                View All
              </Button>
            </div>
          </div>
          <div>
            ...
            {authorized?.length === 0 && (
              <div className="text-center py-4 text-lg text-gray-500">No patients authorized yet</div>
            )}
          </div>
        </div>
        <div className="basis-1/2 border rounded-lg p-4">
          ...
          <div className="mt-4 text-lg text-gray-700">
            <p className="mb-4">
              <strong>1. Authorization by Patient:</strong> Your wallet needs to be authorized by the patient to view
              and append medical records.
            </p>
            <p className="mb-4">
              <strong>2. Wallet Address and QR Code:</strong> Find your wallet address and QR code in your profile on
              the sidebar.
            </p>
            <p className="mb-4">
              <strong>3. Authorization Request:</strong> You may request authorization from the patient, but must wait
              for the patient to authorize your wallet.
            </p>
            <p className="mb-4">
              <strong>4. View and Append Records:</strong> Once authorized, you can view the patient’s profile and
              append new records.
            </p>
            <p className="mb-4">
              <strong>5. Modifying Records:</strong> To modify a record, locate it under the patient’s records. You can
              only modify records you have added.
            </p>
          </div>
        </div>
      </div>
